...
function expectIndexToRenderWithActions(wrapper) {
...
function expectIndexToRenderWithoutActions(wrapper) {
...
describe("vendors/Index", () => {
  describe("when logged in", () => {
    ...
    describe("as admin", () => {
      ...
      it("should render Index with actions", () => {
        expectIndexToRenderWithActions(createWrapper());
      });
    });
    ...
    describe("as editor", () => {
      ...
      it("should render Index without actions", () => {
        expectIndexToRenderWithoutActions(createWrapper());
      });
    });
  ...
  describe("when not logged in", () => {
    it("should render LoginForm", () => {
      expectLoginToRender(createWrapper());
    });
  });
});
